...
- Install NodeJS LTS from [NodeJs Official Index](https://nodejs.org/en/?ref=horizon-documentation)
  (NOTE: Product only works with LTS version)

- Install Yarn CLI from [Yarn Official Index](https://yarnpkg.com/cli/install?ref=horizon-documentation)
